...
Version: 1.0.0
Author: Scientific Notation Converter / www.calculator.io
...
function display_calcio_ci_scientific_notation_converter(){
    $page = 'index.html';
...
add_shortcode( 'ci_scientific_notation_converter', 'display_calcio_ci_scientific_notation_converter' );